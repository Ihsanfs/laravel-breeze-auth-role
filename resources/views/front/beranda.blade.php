            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8 text-center">
                        <h2>Instansi</h2>
                        <div class="card p-2">
                            <img src="{{ asset($instansi->foto_instansi) }}" class="img-fluid" alt="">
                                ...
                                <div class="row">
                                    @foreach ($galeri as $item)
                                        ...
                                        <div class="modal fade" id="galleryModal{{ $item->id }}" tabindex="-1"
                                            role="dialog" aria-labelledby="galleryModalLabel{{ $item->id }}"
                                            aria-hidden="true">
                            ...
                            @foreach ($berita as $key => $item)
                                <div class="col-lg-4 mb-2">
                                    <div class="post-box">
                                        ...
                                        <span class="post-date">{{ $item->created_at->formatLocalized('%A, %d %B %Y') }}
                                            <span><i class="fa-solid fa-eye"></i> {{ $item->views }} </span></span>
