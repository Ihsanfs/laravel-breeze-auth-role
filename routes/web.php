...
Route::middleware(['auth', 'verified', 'role:1'])
    ...
    ->group(function() {
        Route::get('/Dashboard', [Super\SuperadminController::class, 'index'])
            ...
            //slide video
            Route::get('/slider', [Super\SlideController::class, 'index'])
            ->name('slider');
            Route::get('/slider/create', [Super\SlideController::class, 'create'])
            ->name('slider_add');
            Route::post('/slider/store', [Super\SlideController::class, 'store'])
            ->name('slider_store');
            Route::get('/slider/{id}/edit', [Super\SlideController::class, 'edit'])
            ->name('slider_edit');
            Route::put('/slider/{id}/update', [Super\SlideController::class, 'update'])
            ->name('slider_update');
            Route::delete('/slider/{id}/delete', [Super\SlideController::class, 'destroy'])
            ->name('slider_delete');
            ...
            ///users
            Route::get('/users', [Super\UsersController::class, 'index'])
            ->name('users');
